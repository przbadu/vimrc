...
This repo is forked from https://github.com/amix/vimrc

> WARNING!! this README file is not upto date, and I am changing some configurations for neovim in this repo
> Another important note is, I have migrated plugin manager from Vundle to VimPlug, so you can easily install/update plugins using `:PlugInstall` command
...
> awesome version is recommended
...
To install for multiple users, the repository needs to be cloned to a location accessible for all the intended users.
	...
	git clone --depth=1 https://github.com/przbadu/vimrc.git /opt/vim_runtime
